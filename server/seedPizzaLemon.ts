...
// ─── PIZZA (01-34) + Extra Käserand (35) ──────────────────────────────────────
const PIZZAS: MenuItem[] = [
    { name: "Margherita", description: "Tomaten, Mozzarella, Oregano", price: 14.00, price45: 24.00, image: IMG("pizzalemon_01_margherita.jpg") },
    { name: "Profumata", description: "Tomaten, Mozzarella, Knoblauch, Petersilie, Oregano", price: 16.00, price45: 27.00, image: IMG("pizzalemon_02_profumata.jpg") },
    { name: "Funghi", description: "Tomaten, Mozzarella, Pilze", price: 16.00, price45: 28.00, image: IMG("pizzalemon_03_funghi.jpg") },
    { name: "Spinat", description: "Tomaten, Mozzarella, Spinat", price: 16.00, price45: 28.00, image: IMG("pizzalemon_04_spinat.jpg") },
    { name: "Gorgonzola", description: "Tomaten, Mozzarella, Gorgonzola", price: 16.00, price45: 28.00, image: IMG("pizzalemon_05_gorgonzola.jpg") },
    { name: "Prosciutto", description: "Tomaten, Mozzarella, Schinken", price: 16.00, price45: 28.00, image: IMG("pizzalemon_06_prosciutto.jpg") },
    { name: "Salami", description: "Tomaten, Mozzarella, Salami", price: 16.00, price45: 28.00, image: IMG("pizzalemon_07_salami.jpg") },
    ...
    { name: "Kebab Pizza", description: "Tomaten, Mozzarella, Kebabfleisch", price: 18.00, price45: 32.00, image: IMG("pizzalemon_17_kebab_pizza.jpg") },
    { name: "Poulet", description: "Tomaten, Mozzarella, Poulet", price: 18.00, price45: 32.00, image: IMG("pizzalemon_18_poulet.jpg") },
    { name: "Carbonara", description: "Tomaten, Mozzarella, Speck, Ei, Rahm", price: 18.00, price45: 33.00, image: IMG("pizzalemon_19_carbonara.jpg") },
    { name: "Gamberetti", description: "Tomaten, Mozzarella, Crevetten, Knoblauch", price: 18.00, price45: 33.00, image: IMG("pizzalemon_20_gamberetti.jpg") },
    { name: "Quattro Formaggi", description: "Tomaten, Mozzarella, 4 verschiedene Käsesorten", price: 19.00, price45: 35.00, image: IMG("pizzalemon_21_quattro_formaggi.jpg") },
    { name: "Quattro Stagioni", description: "Tomaten, Mozzarella, Schinken, Pilze, Peperoni, Artischocken", price: 19.00, price45: 35.00, image: IMG("pizzalemon_22_quattro_stagioni.jpg") },
    { name: "Frutti di Mare", description: "Tomaten, Mozzarella, Meeresfrüchte", price: 19.00, price45: 35.00, image: IMG("pizzalemon_23_frutti_di_mare.jpg") },
    { name: "Verdura", description: "Tomaten, Mozzarella, verschiedenes Gemüse", price: 18.00, price45: 33.00, image: IMG("pizzalemon_24_verdura.jpg") },
    ...
    { name: "Padrone", description: "Tomaten, Mozzarella, Gorgonzola, Pilze", price: 20.00, price45: 35.00, image: IMG("pizzalemon_30_padrone.jpg") },
    { name: "Schloss Pizza", description: "Tomaten, Mozzarella, Kalbfleisch, Speck, scharfe Salami", price: 20.00, price45: 35.00, image: IMG("pizzalemon_31_schloss_pizza.jpg") },
    { name: "Italiano", description: "Tomaten, Mozzarella, Rohschinken, Mascarpone, Rucola", price: 20.00, price45: 35.00, image: IMG("pizzalemon_32_italiano.jpg") },
    { name: "Americano", description: "Tomaten, Mozzarella, Speck, Mais, Zwiebeln", price: 20.00, price45: 35.00, image: IMG("pizzalemon_33_americano.jpg") },
    { name: "Lemon Pizza", description: "Tomaten, Mozzarella, Lammfleisch, Knoblauch, Peperoncini, Scharf", price: 21.00, price45: 36.00, image: IMG("pizzalemon_34_lemon_pizza.jpg") },
    { name: "Extra Käserand", description: "Knuspriger Käserand für Ihre Pizza (33cm: +3.- / 45cm: +6.-)", price: 3.00, price45: 6.00, image: IMG("pizzalemon_35_extra_kaeserand.jpg") },
];
